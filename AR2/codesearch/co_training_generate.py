...
from AR2.codesearch.co_training_generate_new_train import RenewTools
...
from veso_search_lib.utils.config_parser import parse_configs
import collections
...
def main():
    # args = get_arguments()
    config_path = get_arguments().config_path
    configs = parse_configs(config_path, [CoGenerateConfig])
    args: CoGenerateConfig = configs[0]
    return
    set_env(args)
